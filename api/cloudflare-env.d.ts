/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 56ef237d14100f520e5f8bf2ef2a586e)
// Runtime types generated with workerd@1.20260507.1 2026-05-08 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		TERMII_SECRETE_KEY: string;
		TERMII_SMS_SENDER_ID: string;
		TERMII_EMAIL_CONFIG_ID: string;
		TERMII_INVITE_TEMPLATE_ID: string;
		TERMII_RESET_TEMPLATE_ID: string;
		...
		ARCJET_ENV: string;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* api */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "DIRECT_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "NEXT_PUBLIC_AUTH_URL" | "TERMII_BASE_URL" | "TERMII_API_KEY" | "TERMII_SECRETE_KEY" | "TERMII_SMS_SENDER_ID" | "TERMII_EMAIL_CONFIG_ID" | "TERMII_INVITE_TEMPLATE_ID" | "TERMII_RESET_TEMPLATE_ID" | "TERMII_WHATSAPP_SENDER_ID" | "NEXT_PUBLIC_POSTHOG_PROJECT_TOKEN" | "NEXT_PUBLIC_POSTHOG_HOST" | "R2_PUBLIC_URL" | "NEXT_PUBLIC_R2_PUBLIC_URL" | "R2_BUCKET_NAME" | "R2_API_KEY" | "R2_ENDPOINT_URL" | "R2_ACCESS_KEY" | "R2_SECRET_ACCESS_KEY" | "ARCJET_KEY" | "ARCJET_ENV" | "NEXTJS_ENV">> {}
}
